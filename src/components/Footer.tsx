      ...
      <div className="container px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center space-y-4 md:space-y-6">
            ...
            <p className="text-xs opacity-75 pt-4 flex items-center justify-center gap-1">
              Made with <Heart className="w-4 h-4 text-red-500 fill-current" /> by Hayat Foods India PVT. LTD
            </p>
